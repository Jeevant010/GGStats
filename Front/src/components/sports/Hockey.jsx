...
const Hockey = () => {
  ...
  useEffect(() => {
    // TODO: Replace with your actual Hockey API call
    setLoading(false);
  }, []);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface-900">
      ...
      <main className="flex-1 py-6 px-4 lg:px-6 max-w-[1400px] mx-auto w-full">
        <h1 className="text-2xl font-bold text-white mb-6">🏑 Hockey</h1>
        ...
        {!loading && !error && matches.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 text-sm mt-2">Connect an API to display live hockey data.</p>
          </div>
        )}
