...
export default function Slidebar({ isOpen }){
  ...
  return (
    <div>
        ...
        <div className={`group main-slide absolute h-screen w-24 top-[80px] right-0 hover:w-[200px] transition-all duration-300 ease-in-out bg-black text-white shadow-lg z-50 ${isOpen ? 'translate-x-0' : 'hidden translate-x-full'}`}>
